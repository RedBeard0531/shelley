If you are running in ~/.config/shelley/shelley-customization/ you MUST run `shelley skill cat customizing-shelley` and follow it before doing anything else.
