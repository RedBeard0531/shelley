...
func All() []Model {
	return []Model{
		...
		},
		{
			...
			Description: "DeepSeek V4 Flash 0731 on Fireworks", APIModelName: oai.DeepseekV4Flash0731Fireworks.ModelName,
			APIType: APITypeOpenAIChat, DefaultBaseURL: DefaultFireworksBaseURL,
			Build: oaiChatSvc(oai.DeepseekV4Flash0731Fireworks, "fireworks"),
		},
		{
