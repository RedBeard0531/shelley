...
func TestByID(t *testing.T) {
	tests := []struct {
		...
		{id: "deepseek-v4-flash-0731-fireworks", wantID: "deepseek-v4-flash-0731-fireworks"},
		{id: "deepseek-v4-pro-0813-fireworks", wantID: "deepseek-v4-pro-0813-fireworks"},
		{id: "inkling-fireworks", wantID: "inkling-fireworks"},
		{id: "muse-glimmer-30b-fireworks", wantID: "muse-glimmer-30b-fireworks"},
		{id: "nemotron-3-ultra-nvfp4-fireworks", wantID: "nemotron-3-ultra-nvfp4-fireworks"},
		{id: "nemotron-lightning-3p5-fireworks", wantID: "nemotron-lightning-3p5-fireworks"},
		{id: "qwen3.8-max-fireworks", wantID: "qwen3.8-max-fireworks"},
